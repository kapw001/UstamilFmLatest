...
//        getActivity().setActionBar(toolbar);//setSupportActionBar(toolbar);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Today Special"));
        tabLayout.addTab(tabLayout.newTab().setText("Masala Coffee"));
        tabLayout.addTab(tabLayout.newTab().setText("Relax Time"));
        tabLayout.addTab(tabLayout.newTab().setText("Kollywood Time"));
